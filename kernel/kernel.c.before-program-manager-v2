...
static void print_help() {
    ...
    kprint("PROGRAMS, PROGS, PROGRAM HELP, PROGRAM INFO NAME, RUNPROG NAME, EXEC NAME\n");
...
static void command_sysinfo() {
    ...
    kprint("Internal program manager: v1 enabled\n");
}
...
void main() {
    ...
    kprint("Program manager v1 initialized.\n");
